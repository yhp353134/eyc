		  	...
		  	<div class="commitbox_inner">
		        <div class="commitbox_top">
		        	...
		        	<table>
		        		...
		        		<tr>
		        			<td style="padding-left: 16px;text-align: right;">默认值：</td><td><input name="ddefault" id="ddefault" type="text" value=""  placeholder="后台附加值时生效" title="默认值"/></td>
	...
	<form action="createCode/proCode.do" name="Form" id="Form" method="post">
		...
		<table style="margin-top: 10px;">
			<tr>
				...
				<td><input type="text" name="packageName" id="packageName" value="" placeholder="这里输入包名 (纯小些字母)" style="width:300px" title="包名称"/></td>
				<td>&nbsp;&nbsp;例如:com.fh.controller.<font color="red" style="font-weight: bold;">system</font>&nbsp;&nbsp;填写红色部分</td>
			</tr>
			<tr>
				<td style="width:76px;text-align: right;">表前缀：</td>
				<td><input type="text" name="tabletop" style="width:300px" id="tabletop" value="SYS_"   placeholder="这里输入表前缀"  title="表前缀"/></td>
				<td>&nbsp;&nbsp;<font color="red" style="font-weight: bold;">会自动在表前面加前缀</font></td>
			</tr>
			<tr>
				<td style="width:15%;text-align: right;">处理表名：</td>
				<td><input type="text" name="objectName" id="objectName" value="" placeholder="这里输入处理类名称" style="width:300px" title="类名称"/></td>
