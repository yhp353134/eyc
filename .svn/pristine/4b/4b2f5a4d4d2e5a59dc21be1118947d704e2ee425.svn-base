...
<div class="navbar navbar-inverse">
		  <div class="navbar-inner">
		   <div class="container-fluid">
			  <a class="brand" >
				  <small style="font-family:微软雅黑;font-size: 80%;">
				  	<img src="static/img/head_top.png" style="width:60px;height: 30px;"> 
				  	<!-- <img src="static/img/zhu1.png"  style="max-width: 40%;">  -->
				    ${pd.SYSNAME} 
				  </small> 
			  </a>
			  <ul class="nav ace-nav pull-right">
					...
					<li class="light-blue user-profile">
						...
						<ul id="user_menu" class="pull-right dropdown-menu dropdown-yellow dropdown-caret dropdown-closer">
							<li><a onclick="editUserPassword();" style="cursor:pointer;"><i class="icon-cog"></i> 修改密码</a></li>
							<c:if test="${postNum > 1 }">
								<li><a onclick="changePost();" style="cursor:pointer;"><i class="icon-user"></i> 切换职位</a></li>
							</c:if>
							<!-- <li id="systemset"><a onclick="editSys();" style="cursor:pointer;"><i class="icon-cog"></i> 系统设置</a></li> -->
							<!-- <li id="productCode"><a onclick="productCode();" style="cursor:pointer;"><i class="icon-cog"></i> 代码生成</a></li> -->
							<li class="divider"></li>
