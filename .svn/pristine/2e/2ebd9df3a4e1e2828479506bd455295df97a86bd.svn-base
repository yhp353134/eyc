...
public class Test {
    ...
    private static String endpoint = "chumi.oss-cn-hangzhou.aliyuncs.com";
    private static String accessKeyId = "LTAITV1oy5nqO3vx";
    private static String accessKeySecret = "LTAITV1oy5nqO3vx";
    private static String bucketName = "chumi";
