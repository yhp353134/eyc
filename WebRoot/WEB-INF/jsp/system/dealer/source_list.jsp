...
<body>
		<div style="width: 100%;margin-top: 10px;"></div>
			<table>
				<tr>
					<form action="sourceGoods/sourceList.do"  method="post"   id="userPost">
					<td>
						<span>
				...
				<tbody>
					<c:forEach items="${userList }"  var="user">
						<tr>
							...
							<td class="center">${user.OWNER_PHONE }</td>
							...
							<td class="center"><script>setDataName('${user.STATUS}')</script></td>
							<td class="center">
