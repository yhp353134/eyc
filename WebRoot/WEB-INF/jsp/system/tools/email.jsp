  ...
  <div class="row-fluid">
			...
			<div class="widget-body">
			 ...
			 <div class="step-content row-fluid position-relative">
				...
				<table style="width:100%;" id="xtable">
					...
					<tr>
						<td id="nr">
							<input type="text" name="TITLE" id="strDealerName" value="" />
							<input type="text" name="TITLE" id="strDealerId" value="" />
						</td>
					</tr>
					<tr>
						<td id="nr">
							<input type="text" name="TITLE" id="strOrgName" value="" />
							<input type="text" name="TITLE" id="strOrgId" value="" />
							<input type="text" name="TITLE" id="strOrgLevel" value="" />
						</td>
					</tr>
					<tr>
						<td style="text-align: center;">
							<a class="btn btn-mini btn-primary" onclick="chooseOrg();">发送</a>  
							&nbsp;<a class="btn btn-mini btn-primary" onclick="chooseDealer();">选择服务站</a>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function chooseOrg(){
			 ...
			 diag.Drag=true;
			 diag.Title ="选择机构";
			 diag.URL = '<%=path%>/tool/org_ztree.do?multChoice=true';
			 diag.Width = 900;
			 diag.Height = 580;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
					...
					$("#strOrgId").val(strDealerId);
					$("#strOrgName").val(strDealerName);
