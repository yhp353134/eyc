 ...
 * @throws Exception
 */
public class SmsHttpSenderUtil {
	...
	public static String batchSend(
		...
		try {
			...
			URI base = new URI(Constants.SMS_SEND_URL, false);
			method.setURI(new URI(base, "HttpBatchSendSM", false));
			method.setQueryString(new NameValuePair[] {
					new NameValuePair("account", Constants.SMS_SEND_COUNT),
					new NameValuePair("pswd", Constants.SMS_SEND_PASSWORD),
